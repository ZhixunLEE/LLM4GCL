...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='GCN', help='the name of model, must match with the model_type')
    ...
    # Training
    parser.add_argument('--ntrail', type=int, default=3, help='repetition count of experiments')
    ...
    args.config_path = './LLM4GCL/configs/{}/{}.yaml'.format(args.model_type, args.model.lower())
